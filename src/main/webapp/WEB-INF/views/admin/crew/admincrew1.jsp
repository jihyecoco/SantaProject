        ...
        <div class="container">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <h1 class="display-5 mb-5">
                    ...
                    <li class="breadcrumb-item" id="all"><a href="/crew/admin/list1.cr">전체</a></li>
                    <li class="breadcrumb-item" id="Mot"><a href="/crew/admin/list1.cr?small=M">등산</a></li>
                    <li class="breadcrumb-item" id="Plg" ><a href="/crew/admin/list1.cr?small=P">플로깅</a></li>
                </ol>
                <br>
                <br>
        	</div>
                        ...
                        <div class="row g-3 mx-auto" >
                        	...
                        	<nav class="navbar navbar-light bg-light">
								<div class="container" style="display: table-cell; vertical-align: middle;">
									<form class="d-flex" action="/crew/admin/list1.cr" method="post">
										<div class="col-sm-2">
