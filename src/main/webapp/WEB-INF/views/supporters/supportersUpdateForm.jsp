...
$(document).ready(function(){
	...
	$('#supo_check').click(function(){
		...
		$.ajax({
			...
			data : ({					
				supportersname : $('input[name=supportersname]').val()
			}),
...
<!-- Quote Start -->
<form:form commandName="supporters" action="/supporters/user/update.su" method="post">
						...
						<div class="row g-3">						
							...
							<div class="col-sm-6">
                                ...
                                <div class="form-floating">
                                    <input type="text" class="form-control border-0" name="supportersname" style="width:600px;" value="${supporters.supportersname}"> 
